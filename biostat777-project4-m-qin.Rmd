---
title: "Visualizing Workers' Access to Transportation in Baltimore, MD in 2022"
author: "Michelle Qin"
...
I only want to pull from the Census API once, so I first check if that has been done already. If so, read in the data from the `data` folder. If not, create a folder called `data` and prepare to download the data there.
